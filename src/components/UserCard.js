          ...
          <div className="col-start-2 col-span-3">
            ...
            <div className="stat">
              <div className="bg-indigo-100 rounded-xl flex flex-row justify-between px-8 py-2 ">
                <div className="flex flex-col space-y-2 items-center">
                  <h1 className="text-gray-700 text-xs font-medium">Repos</h1>
            ...
            <div className="contact grid grid-cols-5 py-4">
              ...
              <div>
                ...
                <><FaTwitter className="text-lg text-gray-600" /><h1>{data.twitter_username}</h1></>):
                <><FaTwitter className="text-lg text-gray-600" /><h1>Not Available</h1></>
